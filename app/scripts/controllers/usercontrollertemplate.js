...
/**
 * @ngdoc function
 * @name cineApp.controller:UsercontrollertemplateCtrl
 * @description
 * # UsercontrollertemplateCtrl
 * Controller of the cineApp
 */
angular.module('cineApp').controller('UsercontrollertemplateCtrl', function($scope, $routeParams, $rootScope, userService, imdbService, restService, $interval, $location) {
